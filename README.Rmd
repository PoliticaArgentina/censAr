...
Paquete de R para trabajar con datos de los Censos de Argentina basado en [_Censo Chile (Redatam) R pkg_](https://github.com/ropensci/censo2017). Esta primera versión en desarrollo permite la descarga de la base de microdatos del CENSO 2010 (exportados como archivos a partir del [CONVERSOR REDATAM](https://github.com/discontinuos/redatam-converter)) obtenidos del portal [datar.info](http://datar.info/group/censos-nacionales). 
